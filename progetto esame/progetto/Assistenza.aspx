...
<asp:Content ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="row">
        <div class="col-md-6">
            Scrivi qui il tipo del problema <asp:TextBox ID="txtOggetto" runat="server"></asp:TextBox><br />
        </div>
    </div>
        <div class="row">
        <div class="col-md-4">
            Scrivi qui la descrizione del problema riscontrato <br />
            <asp:TextBox ID="txtMsg" Width="100%"  runat="server" TextMode="MultiLine"></asp:TextBox>            
        </div>
    </div>
    <div class="row">
        <div class="col-md-4">
